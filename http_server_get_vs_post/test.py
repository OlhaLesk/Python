#!/usr/bin/env python3
#
# Test script for the http get vs post server.
#
# The server should be listening on port 80, answer a GET request with
...
def test_connect():
    ...
    try:
        ...
        return "Server didn't answer on localhost port 80.  Is it running?"
...
def test_GET():
    ...
    elif '<title>GET vs POST</title>' not in r.text:
